 ...
 <div class="container">
  ...
  <div class="row">
    <div class="col">
     ...
     <input type="password" placeholder="Confirm Password">
      <a href=""><button class="btn btn-success" type="submit">Create Account</button></a>
     </form>
    </div>
  </div> -->
  ...
  <div class="row">
    <div class="col">
      ...
      <p><a href="/" class="backlogin"><svg xmlns="http://www.w3.org/2000/svg" width="30" fill="currentColor" class="bi bi-arrow-90deg-left" viewBox="0 0 16 16">
